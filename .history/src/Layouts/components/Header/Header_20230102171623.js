      ...
      <div className={cx('content')}>
        <div className={cx('logo')}>
          <Link to={config.routes.home} className={cx('logoLink')}>
            <img style={{ with: '118px', height: '42px' }} src="~/src/assets/images/logofooter/logotiktok.png" alt="TikTok"></img>
            <img style={{ with: '118px', height: '42px' }} src="~/src/assets/images/logofooter/titletiktok.png" alt="TikTok"></img>
          </Link>
        </div>
