          ...
          {currentUser ? (
            <>
              <div className={cx('current-user')}>
                <Tippy delay={[0, 00]} content="Tải Lên" placement="bottom">
                  <div>
                ...
                <Tippy delay={[0, 00]} content="Tin Nhắn" placement="bottom">
                  <div>
                ...
                <Tippy delay={[0, 00]} content="Thông Báo" placement="bottom">
                  <div>
                    <Button className={cx('action-btn')}>
