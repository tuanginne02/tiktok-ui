...
import { InboxIcon, MessageIcon, UploadIcon, LogoTikTokDarkMode } from '~/components/Icon/Icon';
...
function Header() {
  ...
  return (
    <header className={cx('wrapper')}>
      <div className={cx   <div className={cx('logo')}>
          <Link to={config.routes.home} className={cx('logoLink')}>
            <img style={{ with: '118px', height: '42px' }} src="/media/logotiktok"TikTok"></img>
            {/* <LogoTikTokDarkMode /> */}
          </Link>
        </div>
          ...
          {currentUser ? (
            <>
              <div className={cx('current-user')}>
                <Tippy delay={[0, 500]}  placement="bottom">
                  <div>
                ...
                <Tippy delay={[0, 500]} o" placement="bottom">
                  <div>
                    <Button className={cx('action-btn')}>
