              ...
              <div className={cx('footer-download-items')}>
                ...
                <div className={cx('download-logo')}>
                  <div className={cx('logo')}>
                    <img src="/public/media/logofooter/logo_load/ic-qrcode.svg"  />
                  </div>
                  <div className={cx('logo')}>
                    <img src="/public/media/logofooter/logo_load/amazon.png"  />
                  </div>
                  <div className={cx('logo')}>
                    <img src="/public/media/logofooter/logo_load/apple.png"  />
                  </div>
                  <div className={cx('logo')}>
                    <img src="/public/media/logofooter/logo_load/gg[lay.pngg"  />
                  </div>
                  <div className={cx('logo')}>
                    <img src="/public/media/logofooter/logo_load/microsoft.png"  />
                  </div>
                </div>
              </div>
            </div>
