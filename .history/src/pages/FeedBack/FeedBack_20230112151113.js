              ...
              <div className={cx('footer-download-items')}>
                ...
                <div className={cx('download-logo')}>
                  <div className={cx('logo')}>
                    <img className={cx('logo-img')} src="/media/logofooter/logo_load/qrcode.png" alt="" />
                    <span>QR CODE</span>
                  </div>
                  <div className={cx('logo')}>
                    <img className={cx('logo-img')} src="/media/logofooter/logo_load/amazon.png" alt="" />
                  </div>
                  <div className={cx('logo')}>
                    <img className={cx('logo-img')} src="/media/logofooter/logo_load/apple.png" alt="" />
                  </div>
                  <div className={cx('logo')}>
                    <img className={cx('logo-img')} src="/media/logofooter/logo_load/gg[lay.pngg" alt="" />
                  </div>
                  <div className={cx('logo')}>
                    <img className={cx('logo-img')} src="/media/logofooter/logo_load/microsoft.png" alt="" />
                  </div>
                </div>
              </div>
            </div>
