...
function Profile() {
  ...
  const [isActiveVideos, setIsActiveLikedVideos] = useState(false);
    ...
    <div className={cx('profile')}>
      <div className={cx('profile-content')}>
        ...
        <div className={cx('profile-body')}>
          <div className={cx('btn-body')} onClick={handleClickLikedVideos}>
            <div
            ...
            <div
              ...
              style={{
                ...
                transform: isActiveLikedVideos ? 'translateX(270px)' : 'translateX(0px)',
              }}
            ></div>
          </div>
