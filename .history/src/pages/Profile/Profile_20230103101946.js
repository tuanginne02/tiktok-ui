        ...
        <div className={cx('profile-header')}>
          ...
          <div className={cx('profile-interactive')}>
            ...
            <div className={cx('profile-share')}>
              <div>
                {/*visible */}
                <Tippy visible content="Share" interactive placement="bottom" render={renderPreview}>
        ...
        <div className={cx('profile-body')}>
          <div className={cx('btn-body')}>
            <div className={cx('body-videos')}>
              <Button
                style={{
                  height: isActiveVideos ? 'rgba(24, 25, 35, 0.3)' : '',
                }}
            ...
            <div
              ...
              style={{
                ...
                '&.btnLikes': {
                  color: isActiveLiked ? 'rgba(24, 25, 35, 0.3)' : '',
                },
              }}
            ...
            >
              ...
              >
                ...
                <span id="btn-like"    className={cx('btn-likes')}
                style={{
                  color: isActiveLiked ? 'black' : '',
                }}
                onClick={handleClickLiked}>Liked</span>
              </Button>
            </div>
            <div className={cx('none-line-scroll')}></div>
          </div>
