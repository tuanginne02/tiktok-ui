...
import { UserIcon, NotificationIcon, BlockIcon, ToggleOff, ToggleOn,HomeIcon, } from '~/components/Icon/Icon';
              ...
              <div className={cx('content-right-center')}>
                ...
                <div className={cx('right-center-content')}>
                  ...
                  <div className={cx('data-dowl')}>
                    ...
                    <div className={cx('downl-title')}><span>Download your data</span></div>
