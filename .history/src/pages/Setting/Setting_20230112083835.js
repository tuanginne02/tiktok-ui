        ...
        <div className={cx('setting-body')}>
          ...
          <div className={cx('setting-content')}>
            <div className={cx('content-left')}>
              ...
              <Menu>
                <MenuItem title="For You" icon={<UserIcon />} activeIcon={<HomeActiveIcon />} /
                <MenuItem title="Following" icon={<NotificationIcon />} activeIcon={<UserGroupActiveIcon />} />
                <MenuItem title="LIVE" icon={<BlockIcon />} activeIcon={<LiveActiveIcon />} />
              </Menu>
            </div>
