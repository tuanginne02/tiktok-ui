...
import { UserIcon, NotificationIcon, BlockIcon, ToggleOff, ToggleOn, HomeIcon,HomeActiveIcon,LiveActiveIcon,LiveIcon,UserGroupActiveIcon,UserGroupIcon } from '~/components/Icon/Icon';
            ...
            <div className={cx('content-left')}>
              ...
              <aside className={cx('wrapper')}>
                <Menu>
                  ...
                  />
                  <MenuItem title="LIVE" con={<LiveIcon />} activeIcon={<LiveActiveIcon />} />
                </Menu>
              </aside>
            </div>
