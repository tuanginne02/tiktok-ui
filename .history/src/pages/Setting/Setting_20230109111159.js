...
import { UserIcon, NotificationIcon, BlockIcon, faToggleOn, faT`oggleOff } from '~/components/Icon/Icon';
              ...
              <div className={cx('content-right-center')}>
                ...
                <div className={cx('right-center-body')}>
                  ...
                  <div className={cx('private-acc')}>
                    ...
                    <FontAwesomeIcon icon={toggleOn} />
                    <FontAwesomeIcon icon={toggleOff} />
                  </div>
                </div>
              </div>
