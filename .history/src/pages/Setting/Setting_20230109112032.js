            ...
            <div className={cx('content-right')}>
              ...
              <div className={cx('content-right-center')}>
                ...
                <div className={cx('right-center-body')}>
                  <div className={cx('center-body-')}><span>Discoverability</span></div>
                  <div className={cx('private-acc')}>
                    <span>Private account</span>
                    <FontAwesomeIcon icon={faToggleOn} />
                    <FontAwesomeIcon icon={faToggleOff} />
                  </div>
                  <span>With a private account, only users you approve can follow you and watch your videos. Your existing followers won't be affected.</span>
                </div>
                <div className={cx('right-center-header')}></div>
              </div>
