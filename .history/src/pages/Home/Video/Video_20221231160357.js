...
import VideoJS from '~/assets/video/'
  ...
  return (
    <div className={cx('body-content')}>
      <div className={cx('vidieo')}>
        ...
        /> */}
        <video className={cx('video-bor')} width="350px" height="700px" controls>
          <source src="https://www.youtube.com/watch?v=JHSRTU31T14" type="video/mp4" />
        </video>
      </div>
