...
import video from '~/assets/video/SonTungMTP.mp4';
...
function Video() {
  ...
  <div className="app">
    <button
      className={this.state.BackgroundColor === 'BLACK' ? 'Black' : 'White'}
      onClick={() => {
    ...
    <div className={cx('body-content')}>
      <div className={cx('vidieo')}>
        ...
        <video
          ...
          width="350"
          height="700"
          poster="/public/media/userFl/sontung.jpg"
          data-setup="{}"
        >
      ...
      <div className={cx('icon-body')}>
        <button className={cx('video-btn')(this.state.BackgroundColor === 'BLACK' ? 'Black' : 'White'}} onClick={handleClick}>
