            ...
            <div className={cx('content-body')}>
              ...
              <div className={cx('payment')}>
                <div className={cx('payment-method')}>
                  ...
                  <img className={cx('img-pay')} src="/media/payment/dinerssvg" alt="" />
                  <img className={cx('img-pay')} src="/media/payment/discoversvg" alt="" />
                  <img className={cx('img-pay')} src="/media/payment/card_americansvg" alt="" />
                  <img className={cx('img-pay')} src="/media/payment/momosvg" alt="" />
                  <img className={cx('img-pay')} src="/media/payment/zalopaysvg" alt="" />
                  <img className={cx('img-pay')} src="/media/payment/bordersvg" alt="" />
                </div>
              </div>
            </div>
          </div>
