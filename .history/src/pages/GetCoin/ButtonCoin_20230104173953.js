...
function ButtonCoin Component() {
  // const [isChangeColor, setIsChangeColor] = useState(false);

  const handleClickChangeColor = (props) => {
    super(props);
  ...
  const toggleArrow = function () {
    if (this.state.status) {
      //closes it
      document.getElementById('arrow').classlist.remove('active-color');
    } else {
      //open
      document.getElementById('arrow').classlist.add('active-color');
    }
  ...
  return (
    <div className={cx('btn-coins-items')}>
      <div className={cx('coins-item', 'active-color')} onClick={handleClickChangeColor}>
