            ...
            <div className={cx('content-body')}>
              ...
              <div className={cx('payment')}>
                <div className={cx('payment-method')}>
                  ...
                  <img className={cx('img-pay')} src="/media/payment/diners" alt="" />
                  <img className={cx('img-pay')} src="/media/payment/discover" alt="" />
                  <img className={cx('img-pay')} src="/media/payment/card_american" alt="" />
                  <img className={cx('img-pay')} src="/media/payment/momo" alt="" />
                  <img className={cx('img-pay')} src="/media/payment/zalopay" alt="" />
                  <img className={cx('img-pay')} src="/media/payment/border" alt="" />
                </div>
              </div>
            </div>
          </div>
