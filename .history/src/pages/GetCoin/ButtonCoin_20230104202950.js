...
function ButtonCoin() {
  const [isChangeColor1, setIsChangeColor1] = useState(false);
  const [isChangeColor2, setIsChangeColor2] = useState(false);
  // const [isChangeColor1, setIsChangeColor1] = useState(false);
  // const [isChangeColor1, setIsChangeColor1] = useState(false);
  // const [isChangeColor1, setIsChangeColor1] = useState(false);
  // const [isChangeColor1, setIsChangeColor1] = useState(false);
  ...
  // };
  return (
    <div className={cx('btn-coins-items')} onClick={() => setIsChangeColor1(!isChangeColor1)}>
      <div className={cx('coins-item', isChangeColor1 && 'active-color')}>
      ...
      <div
        className={cx('coins-item', isChangeColor2 ? 'active-color' : '')}
        onClick={() => setIsChangeColor2(!isChangeColor2)}
      >
        <Button className={cx('btn-layout')}>
          <div className={cx('coins')}>
            <CoinTikTokGold />
      ...
      <div
        className={cx('coins-item',? 'active-color' : '')}
