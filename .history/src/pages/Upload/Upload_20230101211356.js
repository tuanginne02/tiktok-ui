            ...
            <div className={cx('content-manipulation-upload')}>
              ...
              <div className={cx('check-watch-video')}>
                ...
                <div className={cx('check-user')}>
                  <input type="checkbox" className={cx('inp-check-user')}>Comment</input>
                  <input type="checkbox" className={cx('inp-check-user')}>Duet</input>
                  <input type="checkbox" className={cx('inp-check-user')}>Stich</input>
                </div>
              </div>
