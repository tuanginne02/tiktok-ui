        ...
        <div className={cx('content-upload')}>
          ...
          <div className={cx('content-manipulation-upload')}>
            ...
            <div className={cx('title-remind')}>
              <span className={cx('title-remind-title')}>We'll check your video for potential copyright infringements on used sounds. If infringements are found, you can edit the video before posting. </span>
