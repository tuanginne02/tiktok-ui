...
import { ToggleOff, ToggleOn, InforError,CoinTikTokGold } from '~/components/Icon/Icon';
...
function Upload() {
  ...
  const handleChangeTitle = () => {
    setChangeTitle((current) => !current);
  };
              ...
              <div className={cx('item-left')}>
                <div className={cx('content-manipulation-upload')}>
                  ...
                  <div className={cx('title-remind')}>
                    <div className={cx('title-off')} style={{ display: isToggle ? 'none' : '' }}>
                    ...
                    <div className={cx('title-on')} style={{ display: !isToggle ? 'none' : '' }}>
                      <InforError />
                      <span className={cx('title-remind-title')}>
