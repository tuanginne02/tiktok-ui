          ...
          <div className={cx('content-post-upload')}>
            ...
            <div className={cx('content-post')}>
              ...
              <div className={cx('content-post-upload-btn')}>
                <div className={cx(ti')}>MP4 or WebM</div>
                <div className={cx(ti')}>720x1280 resolution or higher</div>
                <div className={cx(ti')}>Up to 10 minutes</div>
                <div className={cx(ti')}>Less than 2 GB</div>
              </div>
