          ...
          <div className={cx('content-post-upload')}>
            ...
            <div className={cx('content-post')}>
              ...
              <div className={cx('content-post-upload-btn')}>
                <div className={cx(')}>MP4 or WebM</div>
                <div className={cx(')}>720x1280 resolution or higher</div>
                <div className={cx(')}>Up to 10 minutes</div>
                <div className={cx(')}>Less than 2 GB</div>
              </div>
