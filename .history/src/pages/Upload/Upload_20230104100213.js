...
function Upload() {
  ...
  const [isClickDuet, setIsCClickDuet] = useState(false);
                  ...
                  <div className={cx('check-watch-video')}>
                    ...
                    <div className={cx('check-user')}>
                      <div className={cx('checkbox-user')}>
                        <input type="checkbox" value="comment" className={cx('inp-check-user')} checked={isChecked} />
                        <span onClick={handleClickComment}></span>
                        Comment
                      </div>
                      <div className={cx('checkbox-user')}>
                        <input type="checkbox" value="Duet" className={cx('inp-check-user')} checked={isChecked} />
                        <span onClick={handleClickDuet}></span>
                        Duet
                      </div>
                      <div className={cx('checkbox-user')}>
                        <input type="checkbox" value="Stich" className={cx('inp-check-user')} checked={isChecked} />
