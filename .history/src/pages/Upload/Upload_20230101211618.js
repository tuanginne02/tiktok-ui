          ...
          <div className={cx('item-left')}>
            <div className={cx('content-manipulation-upload')}>
              ...
              <div className={cx('check-watch-video')}>
                ...
                <div className={cx('finish-check-title')}>Allow user to:</div>
                <div className={cx('check-user')}>
                 <div className={cx('checkbox-user')}> <input type="checkbox" className={cx('inp-check-user')} /></div>
                <div >  <input  type="checkbox" className={cx('inp-check-user')} /></div>
               <di>   <input  type="checkbox" className={cx('inp-check-user')} /></di>
                </div>
              </div>
