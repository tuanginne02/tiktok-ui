...
function Upload() {
  ...
  //     </div>
  //   );
  const [people, setPublic] = useState('Public');
            ...
            <div className={cx('item-left')}>
              <div className={cx('content-manipulation-upload')}>
                ...
                <div className={cx('check-watch-video')}>
                  ...
                  <select className={cx('inp-check-watch')} value={public} onChange={handleChange}>
            ...
            <div className={cx('footer-header')}>
              <div className={cx('footer-header-logo')}>
                <img
                  ...
                  src="~/assets/images/logofooter/logotiktok.png"
                  alt="TikTok"
                ></img>
                <img
                  style={{ with: '118px', height: '42px' }}
                  src="~/assets/images/logofooter/titletiktok.png"
                  alt="TikTok"
                ></img>
              </div>
              <div className={cx('footer-header-column')}>
                <h4>Company</h4>
                <span className="column-title-footer">About</span>
                <span className="column-title-footer">Newsroom</span>
                <span className="column-title-footer">Contact</span>
                <span className="column-title-footer">Carreers</span>
                <span className="column-title-footer">ByteDance</span>
              </div>
              <div className={cx('footer-header-column')}>
                <h4>Programs</h4>
                <span className="column-title-footer">Tiktok for Good</span>
                <span className="column-title-footer">Advertise</span>
                <span className="column-title-footer">Developers</span>
                <span className="column-title-footer">Tiktok Rewards</span>
                <span className="column-title-footer">Tiktok Browse</span>
                <span className="column-title-footer">Tiktok Embeds</span>
              </div>
              <div className={cx('footer-header-column')}>
                <h4>Support</h4>
                <span className="column-title-footer">Help Center</span>
                <span className="column-title-footer">Safety Center</span>
                <span className="column-title-footer">Creator Portal</span>
                <span className="column-title-footer">Community Guidelines</span>
                <span className="column-title-footer">Transparency</span>
                <span className="column-title-footer">accessibility</span>
              </div>
              <div className={cx('footer-header-column')}>
                <h4>Legal</h4>
                <span className="column-title-footer">Terms off Use</span>
                <span className="column-title-footer">Privacy Policy</span>
              </div>
            </div>
            <div className={cx('footer-bottom')}>
              <div className={cx('footer-bottom-left')}>
                <select className={cx('inp-check-watch')} value={myCar} onChange={handleChange}>
                  <option value="enl">Tiếng Anh</option>
                  <option value="vni">Tiếng Việt</option>
                  <option value="kore">Tiếng Hàn</option>
                </select>
              </div>
              <div className={cx('footer-bottom-right')}></div>
            </div>
          </div>
        </div>
        {/* <Footer /> */}
