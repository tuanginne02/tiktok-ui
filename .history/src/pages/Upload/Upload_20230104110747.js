                ...
                <div className={cx('content-manipulation-upload')}>
                  ...
                  <div className={cx('finish-check')}>
                    ...
                    <div className={cx('icon-check')}>
                      <Button className={cx('btn-toggl')} onClick={handleToggle} style={{ display: isToggle ? 'none' : '' }}>
                        <ToggleOff className={cx('icon-tgoff')} />
                      </Button>
                      <Button className={cx('btn-toggl')} onClick={handleToggle} style={{ display: isToggle ? '' : 'block' }}>
