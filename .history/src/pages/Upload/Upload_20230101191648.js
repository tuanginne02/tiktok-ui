        ...
        <div className={cx('content-upload')}>
          ...
          <div className={cx('content-manipulation-upload')}>
            <div className={cx('caption')}>
                <span className={cx('caption-title')}>Manipulation</span>
                <input type="file" accept="image/*" className={cx('inp-manipulation')}></input>
            </div>
            <div className={cx('cover')}></div>
            <div className={cx('check-watch-video')}></div>
            <div className={cx('finish-check')}></div>
