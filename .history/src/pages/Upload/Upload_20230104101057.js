...
import { faCloudArrowUp, faToggleLargeOff ,faToggleLargeOff} from '@fortawesome/free-solid-svg-icons';
              ...
              <div className={cx('item-left')}>
                <div className={cx('content-manipulation-upload')}>
                  ...
                  <div className={cx('finish-check')}>
                    ...
                    <FontAwesomeIcon className={cx('toggle-check')} icon={faToggleLargeOff} />
                    <FontAwesomeIcon className={cx('toggle-check')} icon={faToggleLargeOn} />
                  </div>
